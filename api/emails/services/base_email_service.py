    ...
    def send_email(
        ...
        if EmailConfig.use_celery():
            ...
            try:
                ...
                # If Celery is unavailable (tests or broker down), fall back
                # to synchronous sending to avoid hard failures.
                logger.warning(
                    "Celery dispatch failed, falling back to sync send: %s", str(e)
                )
