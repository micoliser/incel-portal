...
urlpatterns = [
    ...
    path('notifications/<uuid:notification_id>/read', views_api.NotificationMarkReadView.as_view(), name='notifications-mark-read'),
    path('notifications/<uuid:notification_id>', views_api.NotificationDeleteView.as_view(), name='notifications-delete'),
    ...
    path('notifications/subscriptions/<uuid:subscription_id>', views_api.PushSubscriptionDeleteView.as_view(), name='notifications-subscription-delete'),
]
